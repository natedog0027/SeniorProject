...
import { BaseAxis } from 'vega-typings/types/spec/axis';
import { Color } from 'vega-typings/types/spec/color';
import { URI } from 'vega-typings/types/spec/data';
import {
  Blend,
  ColorValueRef,
  Gradient,
  ...
  Text,
  TextDirection
} from 'vega-typings/types/spec/encode';
import { LayoutBounds } from 'vega-typings/types/spec/layout';
import { BaseLegend } from 'vega-typings/types/spec/legend';
import { Locale } from 'vega-typings/types/spec/locale';
import { BaseProjection } from 'vega-typings/types/spec/projection';
import { InitSignal, NewSignal, SignalRef } from 'vega-typings/types/spec/signal';
import { BaseTitle, TitleAnchor } from 'vega-typings/types/spec/title';
